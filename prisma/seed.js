...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.box.createMany({
                        data: [
                            { name: faker_1.faker.company.name(), isHeadquarter: true, location: faker_1.faker.location.streetAddress() }
                        ]
                    })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, prisma.athlete.createMany({
                            data: Array.from({ length: 200 }, function () { return ({
                                firstName: faker_1.faker.person.firstName(),
                                lastName: faker_1.faker.person.lastName(),
                                profileImageUrl: faker_1.faker.image.avatar(),
